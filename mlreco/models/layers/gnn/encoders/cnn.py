...
from mlreco.models.layers.common.cnn_encoder import CNNEncoder
from mlreco.models.experimental.layers.pointnet import PointNetEncoder


def _get_encoder_model(name):
    models = {
        'cnn': CNNEncoder,
...
class ParametricEncoder(nn.Module):
    ...
    def __init__(self, cfg, **kwargs):
        ...
        self.encoder      = _get_encoder_model(self.encoder_name)(cfg)
        
        self.num_features = self.encoder.latent_size
...
#         # Initialize the CNN
#         self.encoder = CNNEncoder(model_config)
